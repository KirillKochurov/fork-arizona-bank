...
local pincode 			= imgui.ImBuffer(tostring(cfg.main.pincode):gsub("^PIN", ""), 128)
local username 			= imgui.ImBuffer(u8(cfg.main.username), 256)
...
function main()
	...
	while true do
		...
		if result and isUniformWearing() and cfg.main.rank >= 2 then
			go_expel(id)
		end
...
function imgui.BeforeDrawFrame()
	if font == nil then
		...
		SOC_ICONS = {}
		for name, data in pairs(socialIcon) do
			SOC_ICONS[name] = imgui.CreateTextureFromMemory(memory.strptr(data), #data)
		end
	end
end
	...
	if bank.alpha > 0.00 then
		...
		if type_window.v == 5 then -- Настройки
			...
			if (cfg.main.username):find("%S") == nil then
				imgui.SameLine(10)
				local self_id = select(2, sampGetPlayerIdByCharHandle(PLAYER_PED))
				imgui.TextDisabled(rpNick(self_id))
			end
			...
			imgui.BeginGroup()
				imgui.Image(SOC_ICONS["vk"], imgui.ImVec2(32, 32))
				if imgui.IsItemClicked() then
					os.execute("explorer https://vk.me/cosui")
				end
				imgui.SameLine(nil, 10)
				imgui.Image(SOC_ICONS["tg"], imgui.ImVec2(32, 32))
				if imgui.IsItemClicked() then
					os.execute("explorer https://t.me/cosmo_way")
				end
				imgui.SameLine(nil, 10)
				imgui.Image(SOC_ICONS["bh"], imgui.ImVec2(32, 32))
				if imgui.IsItemClicked() then
					os.execute("explorer https://blast.hk/members/217639")
				end
				imgui.SameLine(nil, 10)
				imgui.Image(SOC_ICONS["cs"], imgui.ImVec2(32, 32))
				if imgui.IsItemClicked() then
	...
	for k, v in ipairs(notify.messages) do
		...
		if notify.active < notify.max then
			...
			if v.active then
				...
				imgui.Begin(u8'##notifycard'..k, _, imgui.WindowFlags.NoCollapse + imgui.WindowFlags.NoResize + imgui.WindowFlags.NoScrollbar + imgui.WindowFlags.NoMove + imgui.WindowFlags.NoTitleBar + imgui.WindowFlags.NoFocusOnAppearing + imgui.WindowFlags.NoBringToFrontOnFocus)
					local p = imgui.GetCursorScreenPos(); p.x = p.x + 68
					local ws = imgui.GetWindowSize(); ws.x = ws.x - 68
					local bar_size = (v.bar_time - (os.clock() - v.start)) / ( v.bar_time / ws.x )
					if bar_size > 0 then
						imgui.GetWindowDrawList():AddRectFilled(
							imgui.ImVec2(p.x, p.y + (ws.y - 3)), 
							imgui.ImVec2(p.x + bar_size, p.y + ws.y), 
							imgui.ColorConvertFloat4ToU32(imgui.ImVec4(0.70, 0.75, 0.88, (v.time - os.clock()) / 1.0)), 
							3, 6
						)
					end
					imgui.SetCursorPos(imgui.ImVec2(0, 10))
					imgui.Image(NOTF_ICON, imgui.ImVec2(69, 61), imgui.ImVec2(0, 0), imgui.ImVec2(1, 1), imgui.ImVec4(0.80, 0.80, 1.00, 1.00))
					imgui.SameLine()
					imgui.BeginGroup()
...
function onWindowMessage(msg, wparam, lparam)
	...
	if msg == 0x0100 then
		...
		elseif wparam == 0x42 and isKeyDown(VK_CONTROL) then -- B
			consumeWindowMessage()
			if not bank.state and not int_bank.state then
				type_window.v = 1
				bank:switch()
			end
		end
...
function se.onSendChat(msg)
	...
	if msg:find('{my_name}') then
		local id = select(2, sampGetPlayerIdByCharHandle(PLAYER_PED))
		if string.find(cfg.main.username, "%S") then
			msg = msg:gsub('{my_name}', cfg.main.username)
		else
...
notfIcon = ""
socialIcon = {
	vk = "",
	tg = "",
	bh = "",
	cs = ""
}